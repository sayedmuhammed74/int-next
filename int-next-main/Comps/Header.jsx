...
const Header = () => {
  return (
    <>
      <div
        className={`${styles.header}  sm:h-screen flex md:flex-row flex-col-reverse mx-auto md:px-10 px-2 py-8 justify-between items-center my-0 text-white`}
      >
        {/* first */}
        ...
        <div className="flex md:mt-10 mt-0 items-center md:w-1/2 w-8/12">
          <Image
            ...
            alt=""
          />
          <div className="md:mt-28 mt-6 relative">
