  ...
  return (
    <div className="md:p-20 p-3 md:mt-2 mt-0 mx-auto">
      ...
      <Image
        ...
        src={require('./../../public/imgs/overview.png')}
        alt=""
      />
      ...
      <p className="mb-8 text-graytext ml-5 leading-7">
        ...
        be people you work with on a frequent basis and whom you expect to work
        with for at least one year. We understand however that this may not be
        feasible for everyone, and if you believe the potential nominees from
        your new job will not have sufficient understanding of your skills
        before the deadline, you may reach out to nominees from your previous
        job instead.
      </p>
